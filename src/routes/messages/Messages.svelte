    ...
    <div class="hidden md:flex flex-col w-52 bg-surface-900/50 border-r border-surface-700/20 shrink-0">
      <div class="p-3 border-b border-surface-700/20">
        <button
          ...
          class="w-full py-2.5 px-3 rounded-m3-full bg-primary-500 text-white text-label-large hover:bg-primary-400 active:scale-[0.98] shadow-lg shadow-primary-500/30 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div class="flex gap-1.5 px-3 py-2 border-b border-surface-700/20 bg-surface-900/20 shrink-0 overflow-x-auto no-scrollbar">
        {#each [
          ...
          <button
            ...
            class="flex items-center gap-1 px-2.5 py-1 rounded-m3-sm text-label-medium whitespace-nowrap shrink-0 transition-all
 {msgFilter === f.id
        ...
        <div class="p-6 space-y-5">
          ...
          <div class="pt-4 border-t border-surface-800/50 flex flex-wrap gap-2">
            <button
              ...
              class="flex items-center gap-2 px-5 py-2.5 rounded-m3-full bg-primary-500 text-white text-label-large shadow-lg shadow-primary-500/25 active:scale-95 transition-all"
            >
...
{#if aiSummaryLoading && aiMessageId === selectedMessage?.id}
            ...
            <button
              onclick={replyToMessage}
              class="w-full flex items-center justify-center gap-2 py-3.5 rounded-m3-full bg-primary-500 text-white text-label-large shadow-xl shadow-primary-500/25 active:scale-95 transition-all"
            >
              <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 17-5-5 5-5m10 5H5"/></svg>
              Beantwoorden
            </button>
...
{#if showCompose}
  <div class="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-end md:items-center justify-center p-0 md:p-4">
    ...
    <div class="bg-surface-900 border border-surface-700/40 rounded-t-m3-xl md:rounded-m3-xl w-full md:max-w-lg shadow-2xl relative flex flex-col max-h-[90vh]">
      <!-- Header -->
      ...
      <div class="shrink-0 border-t border-surface-800 px-5 py-4 bg-surface-900 flex gap-3">
        <button
          ...
          class="flex-1 py-3 rounded-m3-full bg-surface-800 text-gray-300 text-label-large hover:bg-surface-700 transition-all"
        >
          Annuleren
        </button>
        <button
          ...
          class="flex-1 flex items-center justify-center gap-2 py-3 rounded-m3-full bg-primary-500 text-white text-label-large disabled:opacity-40 hover:bg-primary-400 shadow-lg shadow-primary-500/30 transition-all active:scale-95"
        >
          {#if composeSending}
